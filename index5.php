                    ...
                    <div id="nonMemberFee">
                        ...
                        <div class="payment-details">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="text" class="form-control" readonly value="Conference Organizing Committee">
                            </div>
                            <div class="mb-2">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="text" class="form-control" readonly value="Bank Example">
                            </div>
                            <div class="mb-2">
                                <label class="form-label">Bank Address:</label>
                                <input type="text" class="form-control" readonly value="123 Bank Street, Manado">
                            </div>
                            <div class="mb-2">
                                <label class="form-label">SWIFT Code:</label>
                                <input type="text" class="form-control" readonly value="BANKIDJA">
                            </div>
                        </div>
                    </div>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div id="tourDetails" style="display: none;">
                        <div class="mb-3">
                            <label for="tour_price" class="form-label">Tour Price</label>
                        ...
                        <div class="payment-details">
                            ...
                            <div class="mb-2">
                                <label class="form-label">Account Name:</label>
                                <input type="text" class="form-control" readonly value="Conference Organizing Committee - Tour">
                            </div>
                            <div class="mb-2">
                                <label class="form-label">Account Number:</label>
                            ...
                            <div class="mb-2">
                                <label class="form-label">Bank Name:</label>
                                <input type="text" class="form-control" readonly value="Another Bank">
                            </div>
                            <div class="mb-2">
                                <label class="form-label">Bank Address:</label>
                                <input type="text" class="form-control" readonly value="456 Tour Street, Manado">
                            </div>
                            <div class="mb-3">
